...
<!-- <script src="js/qgis2web_expressions.js"></script>
        ...
        }).fitBounds([[-7.611376387196187,110.69213104571584],[-7.608721986369072,110.697066988391]]);
        ...
        function pop_Titikkoordinat_1(feature, layer) {
            var popupContent = '<table>\
                    ...
                    <tr>\
                        ...
                        <td>' + (feature.properties['Karbon'] !== null ? autolinker.link(feature.properties['Karbon'].toLocaleString()) : '') + '</td>\
                    </tr>\
                    <tr>\
                    ...
                    <tr>\
                        <th scope="row">Kesuburan</th>\
                        <td>' + (feature.properties['Kesuburan'] !== null ? autolinker.link(feature.properties['Kesuburan'].toLocaleString()) : '') + '</td>\
                    </tr>\
                </table>';
        ...
        setBounds();
        var i = 0;
        layer_Titikkoordinat_1.eachLayer(function(layer) {
            var context = {
                feature: layer.feature,
                variables: {}
            };
            layer.bindTooltip((layer.feature.properties['Kode'] !== null?String('<div style="color: #ffffff; font-size: 10pt; font-family: \'Arial\', sans-serif;">' + layer.feature.properties['Kode']) + '</div>':''), {permanent: true, offset: [-0, -16], className: 'css_Titikkoordinat_1'});
            labels.push(layer);
            totalMarkers += 1;
              layer.added = true;
              addLabel(layer, i);
        ...
        map.addControl(new L.Control.Search({
            layer: layer_Titikkoordinat_1,
            initial: false,
            hideMarkerOnCollapse: true,
            propertyName: 'Kode'}));
        document.getElementsByClassName('search-button')[0].className +=
         ' fa fa-binoculars';
        resetLabels([layer_Titikkoordinat_1]);
